...
class Student
    ...
    def to_s
        "ID: #{id}, Surname: #{surname}, Name: #{name}, Middle Name: #{middle_name}, Contacts: #{contact_info.to_s}"
    end
    
    def short_form
        [id, name_initials, git, contact_info]
    end
    
    def get_generic_info
        "#{name_initials}, Git: #{@git}, Contacts: #{contact_info}"
    end
