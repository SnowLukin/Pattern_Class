...
def test_txt_file_manager
	student_txt = StudentListTxtManager.new("/Users/snowlukin/Desktop/testing/Test/TXT/input_txt.txt")
	student_txt.load_data
	puts student_txt.get_data.to_s
	student_txt.save_data("/Users/snowlukin/Desktop/testing/Test/TXT/output_txt.txt")
end

def test_json_file_manager
	student_json = StudentListJSONManager.new("/Users/snowlukin/Desktop/testing/Test/JSON/input_json.json")
	student_json.load_data
	puts student_json.get_data.to_s
	student_json.save_data("/Users/snowlukin/Desktop/testing/Test/JSON/output_json.json")
end
